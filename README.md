...
├── knowledge_base.txt        # fictional company handbook (54 sections)
...
each, split on `--- Section Title ---`), spanning HR policy and product/support
(e.g. *StockSense Product Overview*, *Service Credit Policy*). Three properties
are built in deliberately, and the golden set probes each:
