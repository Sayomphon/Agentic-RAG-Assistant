...
renders every retrieved snippet with its rank, score, and a provenance badge
(BM25 / embeddings / both under fusion — plus the source file when `KB_PATH`
spans several), together with the full search-attempt
