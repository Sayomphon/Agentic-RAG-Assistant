...
- Generated at: 2026-08-02T16:44:10+07:00
- Baseline ID: `enterprise-phase0-v2`
...
- Source-tree SHA-256: `a5000c41d570c179171200ccf9265d0e621ac755763501cb8f5fa08012178c0f` (70 files)
...
|---|---|---:|---:|
| unit_tests | PASS | 183 | 7722.1 ms |
| keyword_regression | PASS | 15 | 103.0 ms |
| retriever_contract | PASS | 9 | 606.7 ms |

## Retrieval baseline

| mode | hit@k | recall@k | MRR | not-found discipline | avg latency | p95 latency |
|---|---:|---:|---:|---:|---:|---:|
| keyword | 66.7% | 63.9% | 0.650 | 30.0% | 8.0 ms | 0.6 ms |
| semantic | 70.0% | 68.3% | 0.667 | 50.0% | 443.6 ms | 683.9 ms |
| hybrid | 90.0% | 88.9% | 0.900 | 80.0% | 1227.7 ms | 1498.7 ms |

Answerable metrics are separated from negative discipline. A false positive is any result returned for a negative case.

## Runtime health

| mode | implementation | source | query failures | primary failures | secondary uses | secondary failures | fail closed | fusion fallback | active model | answerability rejections |
|---|---|---|---:|---:|---:|---:|---:|---:|---|---:|
| keyword | BM25Retriever | bm25 | 0 | 0 | 0 | 0 | 0 | 0 | — | 0 |
| semantic | OpenAIEmbeddingRetriever | dense | 0 | 0 | 0 | 0 | 0 | 0 | — | 0 |
| hybrid | RerankingRetriever | hybrid | 0 | 0 | 0 | 0 | 0 | 0 | BAAI/bge-reranker-v2-m3 | 142 |
